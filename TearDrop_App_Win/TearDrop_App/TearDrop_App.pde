...
private native NativeLong SetCurrentProcessExplicitAppUserModelID(WString appID);
...
final int WINDOW_POSITION_X = 1058;          // WINDOW_POSITION_X
final int WINDOW_POSITION_Y = 160;           // WINDOW_POSITION_Y

final int SENSOR_WINDOW_POSITION_X = 822;    // SENSOR_WINDOW_POSITION_X
final int SENSOR_WINDOW_POSITION_Y = 688;    // SENSOR_WINDOW_POSITION_Y
...
void setup() {
  ...
  setCurrentProcessExplicitAppUserModelID("TEARDROP");
...
void setCurrentProcessExplicitAppUserModelID(String appID) {          // SET_APPLICATION_ID
